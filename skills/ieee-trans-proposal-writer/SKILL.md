...
Read `../_shared/ieee-trans-guidelines.md` before taking any action. Treat it as the controlling source for equation-first method design, notation, domain-generalization assumptions, contrastive-pair logic, ablation defense, visualization limits, and claim calibration.
