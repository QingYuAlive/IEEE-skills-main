...
`ieee-reviewer` performs harsh pre-submission red-team reviews for IEEE Transactions manuscripts, especially TCYB, THMS, and TNNLS papers involving neural networks, time-series learning, sEMG/EEG, contrastive learning, domain generalization, invariant learning, and robust empirical evaluation.
