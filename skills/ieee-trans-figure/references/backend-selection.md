...
Do not ask the user to choose a backend. Do not generate non-Python plotting code in this skill. If the user requests another plotting environment, state that `ieee-trans-figure` is Python-only and offer to provide a Python equivalent.
