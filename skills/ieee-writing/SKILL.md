...
1. Read `../_shared/ieee-guidelines.md` before using any local fragment.
...
Do not draft prose until the user has already passed the `ieee-proposal-writer` math gate or has supplied equivalent material in the current request.
